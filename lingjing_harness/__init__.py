...
from .store_conversation_detail_snapshot import (
    install_conversation_detail_snapshot_boundary as _install_conversation_detail_snapshot_boundary,
)
...
_install_conversation_detail_snapshot_boundary(_store_module)
